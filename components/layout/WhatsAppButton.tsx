...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => setAttention(true), 0);
  ...
  return (
    <div className="fixed bottom-[calc(88px+env(safe-area-inset-bottom))] right-5 z-30 lg:bottom-8 lg:right-8">
      <button 
        onClick={handleClick}
        className={`group flex h-12 w-12 items-center justify-center gap-2 rounded-full bg-[#167C3A] text-white shadow-[0_4px_18px_rgba(22,124,58,0.34)] transition-colors duration-200 hover:bg-[#126C32] lg:h-14 lg:w-auto lg:px-4 ${attention ? 'animate-pulse-subtle motion-reduce:animate-none' : ''}`}
